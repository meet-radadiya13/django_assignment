...
urlpatterns = [
    ...
    path("profile/",login_required(TemplateView.as_view(template_name="user/profile.html")),name="profile",),
    ...
    path( "search_company_users/",views.search_company_users,name="search_users"),
